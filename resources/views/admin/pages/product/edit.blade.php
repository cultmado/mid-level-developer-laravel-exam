...
@section('content')
    ...
    <div class="row">
        <form class="form-horizontal" action="{{route('admin.product.update', ['id' => $product->id])}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                <div class="block">
                    <div class="block-title">
                        <h2><i class="fa fa-pencil"></i> <strong>Edit Product</strong></h2>
                    </div>
...
<script type="text/javascript">
    $(function() {
        $('#summernote').summernote({
            ...
            $('#product_category').val('{{$product->categoryPerProduct->productCategory->id}}');
