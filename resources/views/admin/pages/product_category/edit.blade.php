...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="{{ route('admin.product.index') }}">Product Categories</a></li>
        <li><span href="javascript:void(0)">Edit Product Category</span></li>
    </ul>
    <div class="row">
        <form class="form-horizontal" action="{{route('admin.product-category.update', ['id' => $productCategory->id])}}" method="POST">
            @csrf
            <div class="col-md-12">
                <div class="block">
                    <div class="block-title">
                        <h2><i class="fa fa-pencil"></i> <strong>Edit Product Category</strong></h2>
                    </div>
